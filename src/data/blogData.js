export const entryData = [
  {
    ...
    text: {
      ...
      paragraphs: [
        {
          header: `Om Kurset`,
          para: `Kurset legger vekt på grunnleggende observasjonsteknikker som går ut på å bryte ned det vi ser til forenklede gjengivelser av virkeligheten. Disse gjengivelsene vil gradvis bli mer og mer spesifikke, helt til vi når det endelige resultatet. Vi vil jobbe med å finne rytmer, abstrakte mønstre og andre underliggende kvaliteter som ofte gjemmer seg i motivene vi tegner og maler. Disse kvalitetene kan gjengis eller forsterkes for å oppnå ønsket resultat.`,
        },
        {
          header: null,
